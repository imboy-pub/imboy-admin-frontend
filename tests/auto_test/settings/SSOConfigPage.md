...
| 阻塞 | 永久人工道（§1.4 资金/审批/敏感配置写操作） | `src/pages/settings/SSOConfigPage.tsx` | 「LDAP 配置已保存」操作提交成功并刷新列表数据 | 未测 | 批次3 | 0 | 0 | 0 | 资金/审批/配置类敏感操作，自动化跳过 |
| 阻塞 | 永久人工道（§1.4 资金/审批/敏感配置写操作） | `src/pages/settings/SSOConfigPage.tsx` | 「SAML 配置已保存」操作提交成功并刷新列表数据 | 未测 | 批次3 | 0 | 0 | 0 | 资金/审批/配置类敏感操作，自动化跳过 |
| 阻塞 | 永久人工道（§1.4 资金/审批/敏感配置写操作） | `src/pages/settings/SSOConfigPage.tsx` | 「OAuth2 配置已保存」操作提交成功并刷新列表数据 | 未测 | 批次3 | 0 | 0 | 0 | 资金/审批/配置类敏感操作，自动化跳过 |
