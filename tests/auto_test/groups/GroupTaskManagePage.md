...
|---|---|---|---|---|---|---|---|---|---|---|
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 路由直达与权限守卫（未登录跳 /login，无权限跳 403） | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 加载中 / 空态 / 错误态展示（LoadingState / ErrorState） | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 列表数据加载渲染与字段格式化 | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 分页翻页与每页条数切换（筛选/搜索变化时重置 page=1） | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 危险/写操作二次确认弹窗（确认执行与取消） | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupTaskManagePage.tsx` | 导出 CSV（字段完整性与大数据量分页导出） | 未测 | - | 0 | 0 | 0 |  |
