...
| 待首测 | - | `src/pages/groups/GroupCategoryManagePage.tsx` | 危险/写操作二次确认弹窗（确认执行与取消） | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupCategoryManagePage.tsx` | 「分类已删除」操作提交成功并刷新列表数据 | 未测 | - | 0 | 0 | 0 |  |
| 待首测 | - | `src/pages/groups/GroupCategoryManagePage.tsx` | 跳转 `/groups/:id` | 未测 | - | 0 | 0 | 0 |  |
