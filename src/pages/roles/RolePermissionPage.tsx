...
const defaultPermissions: PermissionItem[] = [
  ...
  { key: 'messages:read', name: '查看消息记录（仅元数据，不含内容）', module: '消息管理', path: '/messages' },
  { key: 'messages:metadata:read', name: '查看消息元数据（显式别名）', module: '消息管理', path: '/messages' },
  { key: 'messages:content:read', name: '查看消息内容（需绑定举报工单+原因，逐次审计）', module: '消息管理', path: '/messages' },
  { key: 'messages:export', name: '导出消息 CSV（独立于读取权限）', module: '消息管理', path: '/messages' },
